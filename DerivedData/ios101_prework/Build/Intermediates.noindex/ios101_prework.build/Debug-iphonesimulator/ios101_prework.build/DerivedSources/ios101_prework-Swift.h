...
#ifndef IOS101_PREWORK_SWIFT_H
#define IOS101_PREWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ios101_prework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14ios101_prework11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC14ios101_prework13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC14ios101_prework14ViewController")
@interface ViewController : UIViewController
- (IBAction)changeBackgroundColor:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
